...
export const Update=({focused})=>{
    return(
        <TouchableOpacity style={{borderWidth:2,width:27,height:27,justifyContent:'center',alignItems:'center',borderRadius:10,borderColor:`${focused? "#000":"#aaa"}`}}>
        ...
        <TouchableOpacity>
             {/* <View style={{width:60, height:60, borderRadius:100,justifyContent:'center', alignItems:'center',borderWidth:2,padding:4}}> */}
                        <Image 
                         ...
                         resizeMode='cover'
                         style={{width:32,height:32,borderRadius:100,justifyContent:'center',alignItems:'center',borderWidth:3,borderColor:`${focused? "#000":"#aaa"}`}}
                         />
                    {/* </View> */}
        </TouchableOpacity>
    )
